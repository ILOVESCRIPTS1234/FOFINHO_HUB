...
local Window = OrionLib:MakeWindow({Name = "FOFINHO HUB", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "FOFINHO HUB"})
...
W:AddLabel("[+] FOFINHO HUB is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "FOFINHO HUB(Noitification)",
        ...
        while wait() do
            ...
            if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then
                ...
                OrionLib:MakeNotification({
                    ...
                    Image = "rbxassetid://140699859049061",
                    Time = 5
                })
